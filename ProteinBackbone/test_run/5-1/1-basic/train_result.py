...
epoch, train_loss, val_loss = fileread('pyt183119_14543908.out')
plt.xlabel(r'$\rm epoch$')
# plt.ylabel(r'$\log_{10} ({\rm val\ loss})$')
plt.ylabel(r'${\rm val\ loss}$')
draw_plot_and_scatter(ax, epoch, val_loss)


f.set_size_inches(3.6,3)
plt.savefig('val-2.jpg',dpi=1000, bbox_inches='tight')
plt.show()
